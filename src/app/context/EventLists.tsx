...
export const InsiderBenefits = [
    ...
    membershipFor: ["Individual, age 20", "Culturally curious", "Exclusive, meaningful experiences", "Build community connections"],
    price: 250,
    benefitlist: [
...
},
{
    ...
    price: 200,
    membershipFor: ["Individual, age 20", "Fun, interactive, educational experiences", "Grow cultural engagement"],
    benefitlist: [
    "Digital Membership Card",
    "Welcome Gift (50 QAR)",
    "Monthly Insider Newsletter",
...
},
{
    ...
    price: 500,
    membershipFor: ["Families: 2 adults + up to 4 children", "Children are below the age of 19", "Can add additional adult & children", "Build community connections"],
    benefitlist: [
    "Digital Membership Card",
    "Welcome Gift (50 QAR)",
    "Monthly Insider Newsletter",
