  ...
  return (
    <div className="w-full px-7 pt-7 pb-10 bg-Background-Medjool inline-flex flex-col justify-start items-start gap-7 overflow-hidden">
      ...
      <div className="self-stretch border-b border-Stroke-White-20%/20 inline-flex justify-start items-center gap-6">
        ...
        >
          <div
            className={`justify-start ${activeTab == "tab1" ? "text-Typography-White" : "text-typography-white-64"} text-base font-normal font-['GT_America'] leading-tight cursor-pointer`}
            onClick={() => setActiveTab("tab1")}
          >
            Account Details
          </div>
         {activeTab == "tab1" && ( <div className="self-stretch h-0 outline outline-[1.50px] outline-offset-[-0.75px] outline-Stroke-Brand"></div> )}
        </div>
        <div
          data-color="Purple BG"
          data-status="Default"
        ...
        >
          <div
            className={`justify-start ${activeTab == "tab2" ? "text-Typography-White" : "text-typography-white-64"} text-base font-normal font-['GT_America'] leading-tight cursor-pointer`}
            onClick={() => setActiveTab("tab2")}
          >
            Membership Benefits
          </div>
          {activeTab == "tab2" && ( <div className="self-stretch h-0 outline outline-[1.50px] outline-offset-[-0.75px] outline-Stroke-Brand"></div> )}
        </div>
      </div>
