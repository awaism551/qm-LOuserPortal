...
const TopNavigation: React.FC<TopNavigationProps> = ({ className = "" }) => {
  ...
  return (
    <div data-layer="Top Nav" data-property-1="Default" className={`TopNav w-full px-4 md:px-8 lg:px-[60px] py-5 left-0 top-0 absolute inline-flex justify-between items-center ${className}`}>
