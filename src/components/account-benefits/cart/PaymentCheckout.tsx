          ...
          <div className="self-stretch inline-flex justify-start items-start gap-6">
            ...
            <div className="inline-flex justify-between items-center gap-4 w-full">
                ...
                <div className="w-7 h-7 px-5 py-3 outline outline-1 outline-offset-[-1px] flex justify-center items-center gap-5 overflow-hidden">
                    <div className="justify-start text-Typography-White text-base font-normal font-['GT_America'] leading-tight">1</div>
                </div>
            ...
            <OrderSummary
                ...
                totalValue="QAR 750"
                onCheckout={() => console.log("Proceed to checkout clicked")}
/>
          </div>
        </div>
      </div>
